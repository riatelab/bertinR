...
bt_param(margin = 10, width = 800)|>
  bt_graticule(strokeWidth = 1.5, strokeDasharray = 2, stroke  = "green", 
               step  = 5)|>
  bt_layer(data = data, fill = "#808080") |>
  bt_bubble(data = data, values = "pop", k = 30, tooltip = "$pop") |>
...
bt_param(projection = "InterruptedHomolosine", clip = TRUE) |>
  bt_outline() |>
  bt_graticule() |>
  bt_shadow(data = data, opacity = 0.2) |>
  bt_layer(data = data,
...
bt_param(projection = "PolyhedralWaterman") |>
  ...
  bt_graticule() |>
  bt_bubble(data = data, leg_round = -2, k = 55, values = "pop",
            fill = list(
...
bt_param(projection = "Bertin1953", width = 600) |>
  ...
  bt_regularbubble(data = data, step = 10, values = "pop", k = 10,
                   tooltip = list(
                     "$NAMEen",
                     "",
                     "country value",
